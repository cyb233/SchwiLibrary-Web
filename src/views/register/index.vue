  ...
  <div class="login-container">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="login-form" auto-complete="on"
      ...
      <div class="title-container">
        <h3 class="title">Schwi Library Register</h3>
      </div>
      ...
      <el-form-item prop="confirmPassword">
        ...
        <el-input :key="passwordType" ref="confirmPassword" v-model="registerForm.confirmPassword" :type="passwordType"
          placeholder="confirmPassword" name="confirmPassword" tabindex="2" auto-complete="on"
      ...
      <br />
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;"
        @click.native.prevent="handleLogin">Back To Login</el-button>
    ...
    data() {
      ...
      const validateConfirmPassword = (rule, value, callback) => {
        if (value != this.registerForm.password) {
          callback(new Error('The password can not be different'))
        } else {
          callback()
        }
      }
